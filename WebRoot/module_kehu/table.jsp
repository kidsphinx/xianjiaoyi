...
<div class="formbody">
	...
	<form action="MoHuSelect" method="post">
	...
	<table class="tablelist">
		...
		<tbody>
			...
			<tr>
				...
				<td><c:out value="${map.u_birthday}"/></td>
				<td><c:out value="${map.u_reg_datetime}"/></td>
				...
				<td><c:out value="${map.u_headimg}"/></td>
				<td><a href="SwitchServlet?id=${map.u_id}">权限反转</a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
