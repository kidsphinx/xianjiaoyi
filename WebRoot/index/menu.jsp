...
<dl class="leftmenu">
	...
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="Selectidle">查看闲置信息</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
	<!-- 一个模块开始 -->
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="module_geren/updatepsw.jsp">更改密码</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
	<!-- 一个模块开始 -->
	<dd>
		<div class="title">
			<span><img src="<%=basePath %>images/leftico01.png"/></span>用户管理
		</div>
		<ul class="menuson">
			<li><cite></cite><a href="SelectYongHu">查看用户信息</a><i></i></li>
	...
	<dd>
		<div class="title">
			<span><img src="<%=basePath %>images/leftico01.png"/></span>平台用户省份
		</div>
		<ul class="menuson">
			<li><cite></cite><a href="ChaXunServlet">平台用户省份统计</a><i></i></li>
	...
	<dd>
		...
		<ul class="menuson">
			<li><cite></cite><a href="module_guanjian/keywords.jsp" >关键词列表</a><i></i></li>
		</ul>
	</dd>
	<!-- 一个模块结束 -->
</dl>
