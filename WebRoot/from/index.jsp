		...
		$.ajax({
			...
			success : function(data) {
				...
				for (var i = 0; i < data.length; i++) {
					str += '<a href="DetailServlet?id='+data[i].id+'" target="_blank">' +
	...
	$(function() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				for (var i = 0; i < data.length; i++) {
					str += '<li>' +
						'<a href="DetailServlet?id=' + data[i].id + '" target="_blank">' +
...
<body>
	...
	<div class="section1 wrap clearfix">
		<ul class="sec1_list">
			<li>
				<div class="shuma"></div> <a href="from/list.jsp" class="sec1_list_first">闲置数码</a>
				<a href="#">手机</a> <a href="#">相机</a> <a href="#">笔记本</a>
			</li>
			<li>
				<div class="muying"></div> <a href="#" class="sec1_list_first">闲置母婴</a>
				<a href="#">童装</a> <a href="#">宝宝用品</a> <a href="#">玩具</a>
			</li>
			<li>
				<div class="riyong"></div> <a href="#" class="sec1_list_first">家居日用</a>
				<a href="#">家具</a> <a href="#">家纺</a> <a href="#">日用</a>
			</li>
			<li>
				<div class="jiadian"></div> <a href="#" class="sec1_list_first">影音家电</a>
				<a href="#">大家电</a> <a href="#">小家电</a> <a href="#">料理机</a>
			</li>
			<li>
				<div class="pieshi"></div> <a href="#" class="sec1_list_first">鞋服配饰</a>
				<a href="#">女鞋</a> <a href="#">箱包</a> <a href="#">女装</a> <a href="#">配饰</a>
			</li>
			<li>
			...
			<div class="lunbo_bd">
				<ul>
					<li><a href="#" target="_blank"><img
							src="images1/lunbo.jpg" /></a></li>
					<li><a href="#" target="_blank"><img
							src="images1/lunbo2.jpg" /></a></li>
				</ul>
			</div>
		...
		<div class="personal">
			<div class="clearfix" id="div1">
				<div class="personal_head">
					<img src="images1/danhuang.png">
				</div>
				<p class="personal_hi">Hi，
				<h1>${map_front.u_nickname}</h1>
				<br>这里有更多你感兴趣的！
				</p>
			</div>
			<div class="clearfix">
				<a href="from/login.jsp" class="personal_login" target="_blank">登录</a>
				<a href="from/zhuce.jsp" class="personal_register" target="_blank">注册</a>
			</div>
			<div class="clearfix fabuzhuanma">
				<a href="publish.html" target="_blank" class="fabuxianzhi"> <span
	...
	<div class="wrap like">
		...
		<div class="tabbd">
			<div class="tabc clearfix" style="display:block;" id="youlike">

			</div>
			<div class="tabc clearfix">
				<a href="#" target="_blank"> <img src="images1/ad3.jpg"> <span>puma卫衣
						男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad2.jpg">
					<span>puma卫衣 男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad1.jpg">
					<span>puma卫衣 男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad3.jpg">
					<span>puma卫衣 男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad2.jpg">
					<span>puma卫衣 男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad3.jpg">
			...
			<div class="tabc clearfix">
				<a href="#" target="_blank"> <img src="images1/ad2.jpg"> <span>puma卫衣
						男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad3.jpg">
					<span>puma卫衣 男女 春秋款</span>
				</a> <a href="#" target="_blank"> <img src="images1/ad2.jpg">
		...
		<div class="section_main clearfix">
			<div class="section_left fl">
				<div class="section_left_top">
					<a href="#"> 显示器 </a> <a href="#"> 内存 </a> <a href="#"> 主板 </a> <a
						href="col-xs-offset-0"> 硬盘 </a> <a href="#"> CPU </a> <a href="#">
						显卡 </a> <a href="#"> 平板 </a> <a href="#"> 无线路由器 </a> <a href="#">
						笔记本 </a> <a href="#"> 无线鼠标 </a> <a href="#"> 充电宝 </a> <a href="#">
						移动硬盘 </a> <a href="#"> 数据线 </a>
				</div>
				<div class="section_left_bottom">
					<a href="#"> <img src="images1/sad.png">
					</a>
				</div>
			</div>
			<div class="section_middle fl" id="xiabu"></div>
			<div class="section_right fl">
				<div class="section_right_part">
					<a href="#" class="section_right_part_img" target="_blank"> <img
						src="images1/tututu.png">
					</a>
					<h4>戴上耳机，倾听</h4>
	...
	<div class="footer">
		<ul class="wrap clearfix">
			<li><img src="images1/footer_03.png" alt=""> <span>卖家实名认证</span>
			</li>
			<li><img src="images1/footer_05.png" alt=""> <span>支付宝担保交易</span>
			</li>
			<li><img src="images1/footer_07.png" alt=""> <span>专业团队支撑</span>
			</li>
			<li><img src="images1/footer_09.jpg" alt=""> <span>官方微博</span>
			</li>
		</ul>
	</div>
	<!-- 底部一堆 -->
