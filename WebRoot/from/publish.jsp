...
<base href="<%=basePath%>">
	<meta charset="UTF-8">
	<title>U闲交易平台</title>
	<link rel="stylesheet" type="text/css" href="css1/publish.css">
...
<body>
    ...
    <div class="header">
        <div class="header_main wrap">
            <h1><a href="index.html" target="_blank"></a><img src="images1/logo-2.png"></a></h1>
            <h2>让你的闲置游起来!</h2>
            <ul class="header_menu clearfix">
                ...
                <li><a href="#">降降降</a></li>
                <li><a href="from/publish.jsp" class="active">发布闲置</a></li>
    ...
    <!-- 宝贝信息 -->
    <form action="FaBuServlet" method="post" enctype="multipart/form-data">
    <div class="bbxx wrap">
    	<div class="biaodan"><span>宝贝名称：</span><input type="text" placeholder="标题 品牌品类都是买家喜欢搜索的" name="name"></div>
    	<div class="biaodan"><span>宝贝介绍：</span><textarea name="presentation"></textarea></div>
    	<div class="biaodan"><span>计量单位：</span><input type="text" name="unit"></div>
    	<div class="biaodan"><span>宝贝数量：</span><input type="text" name="amount"></div>
    	<div class="biaodan"><span>宝贝所在地：</span><input type="text" name="location"></div>
    	<div class="biaodan"><span>购买时间：</span><input type="text" name="purchasing_date"></div>
    	<div class="biaodan"><span>购买价格：</span><input type="text" name="original_price"></div>
    	<div class="biaodan"><span>转让价：</span><input type="text" name="transfer_price"></div>
    	<div ><span>交易方式：</span><select name="transfer_mode" name="name">
					<option>线上交易</option>
					<option>线下交易</option>
				</select></div>
    	<div ><span>成色：</span><select name="percentage">
					<option>全新</option>
					<option>八成新</option>
					<option>半成新</option>
				</select></div>
    	<div ><span>所属类别：</span><select name="fk_idletype" >
