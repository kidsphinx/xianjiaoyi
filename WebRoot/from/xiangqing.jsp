    ...
    <div class="xiangqing wrap clearfix">
        ...
        <div class="xiangqing_right fr">
            ...
            <ul class="price">
                ...
                <li class="address">
                    <div class="address_on">至 <span>北京</span></div>
            ...
            <div class="danbao">
                    <div class="danbao_first"><img src="images1/danbao.png" > 担保交易<span>由支付宝先行保管,验货OK再付款到卖家账户。</span></div>
                    <div><img src="images1/jiaoyi.png" > 实名认证<span>经支付宝核实会员身份和银行账户信息,真实可靠。</span></div>                    
            </div>
        </div>
    </div>
